...
# Create gadget
mkdir /sys/kernel/config/usb_gadget/pikeyboard
cd /sys/kernel/config/usb_gadget/pikeyboard
...
echo "Andrew S. Parnell" > strings/0x409/manufacturer
echo "Pi Macroboard" > strings/0x409/product
